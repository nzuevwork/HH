...
## Overview
Построил production-подобную инфраструктуру для непрерывной доставки веб-сервиса с контролируемыми релизами, автоматическим восстановлением и наблюдаемостью.
Основная цель — минимизация времени недоступности сервиса и сокращение MTTR при сбоях.
